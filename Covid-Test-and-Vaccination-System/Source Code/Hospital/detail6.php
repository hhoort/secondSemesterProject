...
WHERE a.`pid` = '$user_id' AND a.`Status2` = '1' AND a.`PStatus33` = 'Sample Collected' AND a.`Dose` = 'First';";
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                    <div class="zain col-xl-12 col-lg-12 col-md-12 col-sm-12">
                        <div class="align-items-center justify-content-between">
                            <form method="post" action="details3.php" enctype="multipart/form-data" class="form-group">
                                <br>
                                ...
                                <div class="input-group">
                                    <select name="pstatus33" class="col-xl-12 col-lg-12 col-md-12 col-sm-12 text-center"
                                        id="statusSelect">
                                        <option value="Sample Collected" selected>Select Status</option>
