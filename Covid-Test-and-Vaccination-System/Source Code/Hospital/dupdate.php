...
INNER JOIN `hospital` AS h ON a.`hospital name` = h.`id` INNER JOIN `vaccines` AS v ON a.`vaccine` = v.`id` INNER JOIN `paitent` AS pp ON a.`pname` = pp.`id` where a.`PStatus` = 'Approve' and a.`Status2` = '1' and a.`PStatus33` = 'Waiting' AND a.`Dose` = 'First';
";
...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Waiting Report</h1>
    </div>
                                ...
                                while ($pro_datas = mysqli_fetch_assoc($pro_results)) {
                                    ...
                                    <tr>
                                        ...
                                        <td style="display: flex; justify-content:space-around;"><a
                                                href="detail4.php?pid=<?php echo $pro_datas['pid']; ?>"
