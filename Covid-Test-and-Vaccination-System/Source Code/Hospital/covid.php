...
INNER JOIN `hospital` AS h ON a.`thospital` = h.`id` INNER JOIN `paitent` AS pp ON a.`tname` = pp.`id`;
";
...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">All Covid Test</h1>
    </div>
                                ...
                                while ($pro_data = mysqli_fetch_assoc($pro_result)) {
                                    ...
                                    <tr>
                                        ...
                                        <td style="display: flex; justify-content:space-around;">
                                            <a href="detail8.php?tid=<?php echo $pro_data['id']; ?>"
