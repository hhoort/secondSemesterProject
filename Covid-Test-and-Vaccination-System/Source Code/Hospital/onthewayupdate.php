...
WHERE a.`pid` = '$user_id' AND a.`Status2` = '1' AND a.`PStatus3` = 'On The Way For Sample Collection';";
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                    <div class="zain col-xl-12 col-lg-12 col-md-12 col-sm-12">
                        <div class="align-items-center justify-content-between">
                            <form method="post" action="detail1.php" enctype="multipart/form-data" class="form-group">
                                <br>
