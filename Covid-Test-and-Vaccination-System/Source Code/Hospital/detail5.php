...
WHERE a.`pid` = '$user_id' AND a.`Status2` = '1' AND a.`PStatus33` = 'On The Way For Sample Collection' AND a.`Dose` = 'First';";
    ...
    while ($rows = mysqli_fetch_assoc($result)) {
        ...
        <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 text-gray-800">On The Way For Sample Collection</h1>
            </div>
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                    <div class="zain col-xl-12 col-lg-12 col-md-12 col-sm-12">
                        <div class="align-items-center justify-content-between">
                            <form method="post" action="details2.php" enctype="multipart/form-data" class="form-group">
                                <br>
                                ...
                                <br>
                                <label for="pstatus3s" style="color:#3498db;">Status</label>
                                <div class="input-group">
                                    <select name="pstatus33" class="col-xl-12 col-lg-12 col-md-12 col-sm-12 text-center"
                                        id="statusSelect">
                                        <option value="On The Way For Sample Collection" selected>Select Status</option>
