...
INNER JOIN `hospital` AS h ON a.`hospital name` = h.`id` INNER JOIN `vaccines` AS v ON a.`vaccine` = v.`id` INNER JOIN `paitent` AS pp ON a.`pname` = pp.`id` where a.`PStatus` = 'Pending' and a.`Status2` = '1';
";
...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Pending Paitent List</h1>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
            <div class="card shadow mb-4">
                <div
                    class="card-header py-3 d-flex flex-row table-responsive align-items-center justify-content-between">
                                ...
                                while ($pro_data = mysqli_fetch_assoc($pro_result)) {
                                    ...
                                    <tr>
                                        ...
                                        <td style="display: flex; justify-content:space-around;"><a
                                                href="approveuser.php?pid=<?php echo $pro_data['pid']; ?>"
                                                class="btn btn-success">Approve</a>
                                            <a href="rejectuser.php?pid=<?php echo $pro_data['pid']; ?>"
