...
INNER JOIN `hospital` AS h ON a.`thospital` = h.`id` INNER JOIN `paitent` AS pp ON a.`tname` = pp.`id` WHERE `tstatus` = 'Pending';;
";
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                    <div class="zain col-xl-12 col-lg-12 col-md-12 col-sm-12">
                        <div class="align-items-center justify-content-between">
                            <form method="post" action="details5.php" enctype="multipart/form-data" class="form-group">
                                <br>
                                ...
                                <div class="input-group">
                                    <select name="tstatus" class="col-xl-12 col-lg-12 col-md-12 col-sm-12 text-center">
                                ...
                                <div id="fileInputWrapper">
                                    <div class="input-group">
                                        <input type="file" name="deliveryFile" accept=".pdf, .doc, .docx, .xls, .xlsx" required>
