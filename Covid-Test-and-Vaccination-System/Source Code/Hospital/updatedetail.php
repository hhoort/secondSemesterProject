...
INNER JOIN `paitent` AS p ON a.`pname` = p.`id` INNER JOIN `hospital` AS h ON a.`hospital name` = h.`id` 
INNER JOIN `vaccines` AS v ON a.`vaccine` = v.`id` 
WHERE a.`pid` = '$user_id' AND a.`Status2` = '1' AND a.`PStatus3` = 'Waiting';";
    ...
    while ($rows = mysqli_fetch_assoc($result)) {
        ...
        <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 text-gray-800">Update Waiting Detail</h1>
            </div>
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                    <div class="zain col-xl-12 col-lg-12 col-md-12 col-sm-12">
                        <div class="align-items-center justify-content-between">
                            <form method="post" action="updatedetails.php" enctype="multipart/form-data" class="form-group">
                                <br>
                                <div class="input-group">
                                    <input type="hidden" name="pid" value="<?php echo $rows['pid'] ?>">
                                    <input type="text" name="pname" required value="<?php echo $rows['Username'] ?>">
