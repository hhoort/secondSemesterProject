...
INNER JOIN `hospital` AS h ON a.`thospital` = h.`id` INNER JOIN `paitent` AS pp ON a.`tname` = pp.`id` where a.`tstatus` = 'Positive';
";
...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Positive</h1>
    </div>
                            ...
                            if (mysqli_num_rows($pro_result) > 0) {
                                while ($pro_data = mysqli_fetch_assoc($pro_result)) {
                                    ...
                                    <tr>
                                        ...
                                        <td><a
                                                href="status.php?tid=<?php echo $pro_data['tid']; ?>"
