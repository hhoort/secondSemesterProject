...
WHERE a.`pid` = '$user_id' AND a.`Status2` = '1' AND a.`PStatus33` = 'Sent To Lab' AND a.`Dose` = 'First';";
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                    <div class="zain col-xl-12 col-lg-12 col-md-12 col-sm-12">
                        <div class="align-items-center justify-content-between">
                            <form method="post" action="details4.php" enctype="multipart/form-data" class="form-group">
                                <br>
                                ...
                                <br>
                                <label for="Dose" style="color:#3498db;">Dose Status</label>
                                <div class="input-group">
